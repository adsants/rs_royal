...
class Template_view extends CI_Controller {
    ...
    function load_view($content, $data = NULL){
		...
		from
			m_menu,t_hak_akses
		WHERE
			m_menu.aktif_menu='Y' and m_menu.LINK_MENU = '".$this->_ci->uri->segment(1)."' and m_menu.id_menu=t_hak_akses.id_menu and t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."'
		");
        ...
        select m_menu.* from m_menu,t_hak_akses where m_menu.ID_PARENT = '0' and m_menu.aktif_menu='Y' and  m_menu.id_menu=t_hak_akses.id_menu and t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."' order by m_menu.URUTAN_MENU");
        ...
        foreach($dataMenu1 as $dataMenuSatu){
			...
			$Parent1 = $this->_ci->db->query("select count(m_menu.ID_MENU) as jumlah from m_menu,t_hak_akses where m_menu.ID_PARENT = '".$dataMenuSatu->ID_MENU."' and m_menu.id_menu=t_hak_akses.id_menu  and m_menu.aktif_menu='Y' and t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."' order by m_menu.URUTAN_MENU");
			...
			if($jumlahParent1->jumlah > 0) {
				...
				$menu2 = $this->_ci->db->query("select m_menu.* from m_menu,t_hak_akses where m_menu.ID_PARENT = '".$dataMenuSatu->ID_MENU."' and m_menu.id_menu=t_hak_akses.id_menu and m_menu.aktif_menu='Y' and  t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."' order by m_menu.URUTAN_MENU");
				...
				foreach($dataMenu2 as $dataMenuDua){
					...
					$Parent2 = $this->_ci->db->query("select count(m_menu.ID_MENU) as jumlah from m_menu,t_hak_akses where m_menu.ID_PARENT = '".$dataMenuDua->ID_MENU."' and m_menu.aktif_menu='Y' and  m_menu.id_menu=t_hak_akses.id_menu and t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."' order by m_menu.URUTAN_MENU");
					...
					if($jumlahParent2->jumlah > 0) {
						...
						$menu3 = $this->_ci->db->query("select m_menu.* from m_menu,t_hak_akses where m_menu.ID_PARENT = '".$dataMenuDua->ID_MENU."' and m_menu.id_menu=t_hak_akses.id_menu  and  m_menu.aktif_menu='Y' and t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."' order by m_menu.URUTAN_MENU");
						...
						foreach($dataMenu3 as $dataMenuTiga){
							...
							$Parent3 = $this->_ci->db->query("select count(ID_MENU) as jumlah from m_menu,t_hak_akses where m_menu.ID_PARENT = '".$dataMenuTiga->ID_MENU."' and m_menu.id_menu=t_hak_akses.id_menu and  m_menu.aktif_menu='Y' and t_hak_akses.id_kategori_user= '".$this->_ci->session->userdata('id_kategori_user')."' order by m_menu.URUTAN_MENU");
