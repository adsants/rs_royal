					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='NAMA_SATUAN_BARANG') echo "selected"; ?> value="NAMA_SATUAN_BARANG">Berdasarkan Nama Satuan Barang</option>
							</select>
						</div>
						<div class="col-sm-6">
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_SATUAN_BARANG);
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NAMA_SATUAN_BARANG,base_url().$this->uri->segment(1)."/delete/".$showData->ID_SATUAN_BARANG);
						?>
					</td>
