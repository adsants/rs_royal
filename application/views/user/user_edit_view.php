				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="input" class="form-control required" value="<?php echo $this->oldData->NAMA_USER; ?>" id="NAMA_USER" name="NAMA_USER">
								<input type="hidden" value="<?php echo $this->oldData->ID_USER; ?>" id="ID_USER" name="ID_USER">
							</div>
						</div>
						<div class="form-group">
